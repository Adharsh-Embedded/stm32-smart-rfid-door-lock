...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	HD44780_PrintStr("Tap the Card");
	HD44780_SetCursor(0,1);
	HD44780_PrintStr("to open the door");
  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		...
		memcpy(sNum, str, 5);
		HAL_Delay(200);
		if ((str[0] == 211) && (str[1] == 32) && (str[2] == 13)
				&& (str[3] == 228) && (str[4] == 150)) {
			...
			HD44780_PrintStr("APPROVED");
			memset(str,0,16);
		}

		else if ((str[0] == 20) && (str[1] == 32) && (str[2] == 183)
				&& (str[3] == 167) && (str[4] == 32)) {
